...
fn1 = "increment0.2-50_1.txt";
fn2 = "increment0.2-50_2.txt";
fn3 = "increment0.2-50_3.txt";
fn4 = "increment0.2-50_4.txt";
fn5 = "increment0.2-50_5.txt";
...
% plot(velo);
title('vel 移動平均')
legend('vel1','vel2','vel3','vel4','vel5')

subplot(3,2,5);
plot(x, sm_acc1, x, sm_acc2, x, sm_acc3, x, sm_acc4, x, sm_acc5);
% plot(acc);
title('acc 移動平均')
legend('acc1','acc2','acc3','acc4','acc5')

subplot(3,2,4);
plot(x, velo1, x, velo2, x, velo3, x, velo4, x, velo5);
% plot(velo);
title('vel　生の値')
legend('vel1','vel2','vel3','vel4','vel5')

subplot(3,2,6);
plot(x, acc1, x, acc2, x, acc3, x, acc4, x, acc5);
% plot(acc);
title('acc　生の値')
legend('acc1','acc2','acc3','acc4','acc5')
